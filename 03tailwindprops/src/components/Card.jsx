...
function Card(props) { // or Card({username,myArr....})  // Card({username,btnTxt="visit me"})
    // console.log("props", props);
    console.log("props", props.username);
    
    return (
        <div className="max-w-xs rounded-md shadow-md bg-black text-gray-100 m-auto mb-4">
            <img
