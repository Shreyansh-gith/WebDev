...
// Using <a> tag causes the whole page to reload 
// Therefore Link is used
//When clicked:
// 1.URL changes
// 2.React Router detects change
// 3.Only component changes
// 4.No refresh
                ...
                items-center mx-auto max-w-7xl">
                    ...
                    >
                        ...
                        lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink  //Navlink provides the functionality to know if the link is active
                                to="/"
                                    className={({isActive}) =>
